...
export class BattleHUD {
  ...
  private gadgetId?: GrowthGadgetId;
  constructor(parent: HTMLElement) {
    ...
    const icon=document.createElement('span');icon.className='hud-gadget-icon';icon.hidden=true;
  ...
  render(state: BattleHUDState) {
    ...
    if(this.gadgetId!==state.gadgetId){
      ...
      this.nodes['gadget-icon'].hidden=!state.gadgetId;
      this.root.querySelector<HTMLImageElement>('.hud-ability>img')!.hidden=!!state.gadgetId;
    }
