...
const parts: Record<GrowthAttachment, string> = {
  none: '<path d="M28 46h160v25H28zM45 36h83v10H45zM68 71l-8 31h25l10-31M132 71l12 25h21l-9-25"/>',
  heavy: '<path d="M22 48h166v22H22zM178 44h20v30h-20M36 40h90v38H36z"/><path d="M48 40v38m14-38v38m14-38v38m14-38v38m14-38v38"/>',
  short: '<path d="M50 48h112v22H50zM150 43h26v32h-26M36 40h32v38H36z"/><path d="M78 48v22m16-22v22m16-22v22"/>',
  quickmag: '<path d="M77 25h58l-8 67-15 15H69l7-30zM69 98h51v15H69z"/><path d="M88 40l-6 48m20-48-6 48m20-48-6 48"/>',
};
function partArt(id: GrowthAttachment) { return `<svg viewBox="0 0 220 130" role="img" aria-label="${GROWTH_ATTACHMENTS[id].name}配件示意图"><g fill="#334b56" stroke="#b7cbd0" stroke-width="3" stroke-linejoin="round">${parts[id]}</g></svg>`; }
