 ...
 * Levels follow Stats_Guns; stronger shield reductions are this game's balance choices. */
...
export const SPECIAL_OFFHANDS = {
  knife: melee('战术刀', 'Knife', 50, 60, 'knife', 2),
  bat: melee('棒球棍', 'Bat', 85, 80, 'sword', 8),
  baton: melee('警棍', 'Baton', 65, 60, 'knife', 14),
  'nine-iron': melee('九号铁杆', 'Nine Iron', 110, 80, 'sword', 20),
  machete: melee('砍刀', 'Machete', 90, 60, 'knife', 26),
  katana: melee('武士刀', 'Katana', 150, 80, 'sword', 32),
  shield: shield('防弹盾', 'Riot', 0.75, 0.1, 2),
  'police-shield': shield('警用盾', 'Police', 0.8, 0.05, 8),
  'blast-shield': shield('防爆盾', 'Blast', 0.78, 0, 14, 0.3),
  buckler: shield('轻型圆盾', 'Pointy', 0.72, 0, 20),
  'meat-shield': shield('重型肉盾', 'Meat', 0.9, 0, 26),
  siegius: shield('角斗士盾', 'Siegius', 0.7, 0.3, 32),
} as const;
