...
export const CONTENT_VERSION = contentFingerprint({ rules: 61, visionRadius: VISION_RADIUS, growthPresets: GROWTH_V3_PRESETS, growthStage: GROWTH_V3_STAGE, growthSound: GROWTH_SOUND_RADII,
