import { VISION_RADIUS, SCREEN_VISION_RADIUS } from '../simulation/Vision';
...
export const CONTENT_VERSION = contentFingerprint({ rules: 68, visionRadius: VISION_RADIUS, screenVisionRadius: SCREEN_VISION_RADIUS, growthPresets: GROWTH_V3_PRESETS, growthStage: GROWTH_V3_STAGE, growthSound: GROWTH_SOUND_RADII,
