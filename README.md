...
新增独立 **PvP 成长对战**：联网大厅创建成长房间，单人直接开局自动补机器人，多人使用真人队伍。提供 Assault、Tank、Sniper、Medic 与七把独立平衡武器，支持团队交火和据点战。Lv1～Lv5 四次三选一、每局一次刷新，第12分钟开放职业 Ultimate；死亡保留成长，支持重连。独立账号/职业成长、三 Perk 槽、成长池、武器配件及成就称号由服务器保存，保留旧战役与账号资产。当前试玩体验已获用户认可，细节平衡留待后续优化；实施与历史验收口径见 [实施与验收](docs/GROWTH_PVP.md)。需要配套服务端，公网未随本地发行更新。
