...
新增独立 **PvP成长试玩（P1）**：联网大厅「创建成长试玩房间」进入统一Assault配装，击杀/助攻获得经验，Lv1～Lv5四次三选一、每局一次刷新，第12分钟开放Ultimate。死亡保留升级，支持断线恢复。此版本尚未加入局外成长奖励；旧战役与账号资产保留。规则、测试、试玩门槛和剩余阶段见 [成长模式实施与验收](docs/GROWTH_PVP.md)。需本次配套服务端，公网未随本次发行更新。
