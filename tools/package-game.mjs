...
appendFileSync(join(folder, 'README.txt'), '\n扩展版本：自定义地图包含失控飞机；单机支持公文包运送计分和雷达。刺客可装备六种近战，重装兵可装备六种盾牌，按职业Lv.1—6免费解锁；Q切换，点击攻击刺击/挥砍，按住攻击举盾。盾随鼠标360度转向，正面160度内减伤70%—90%，部分型号可反弹子弹或额外防爆，无消耗耐久；侧后方可绕防。\n联机入口：http://127.0.0.1:4175/?online 。配套独立服务器位于project-strike-server；客户端包自身不启动权威服务器。在线支持最多8真人席位，PvP、合作生存和公文包，按房间地图兼容性选择。\n联机需另行注册/登录服务端账号，进入房间前可选职业、技能、武器和道具；金币、购买和各职业等级由服务端保存，独立于本机单人进度。普通配装检查解锁条件，公共调试房间仍可游客试玩全部装备。当前测试服务器支持WS降级登录，请使用独立测试密码；后续可改用管理员提供的WSS地址。更改配装后需重新准备；断线30秒内在原页面使用断线重连。多人服务器重启不恢复活动房间。服务器与客户端必须来自同一内容版本。\n单人PvE脚本自动通关为非阻塞诊断；此版本不声明已完成人工跨设备8人或真实设备性能验收。\n');
