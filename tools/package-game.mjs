...
cpSync(join(root, 'public/assets/audio/SOURCES.txt'), join(folder, 'licenses', 'Audio-Sources.txt'));
cpSync(join(root, 'public/assets/audio/Kenney-CC0.txt'), join(folder, 'licenses', 'Kenney-CC0.txt'));
cpSync(join(root, 'public/assets/ui-v2/SOURCES.txt'), join(folder, 'licenses', 'UI-Art-Sources.txt'));
