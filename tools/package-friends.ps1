...
“太空站 · 轨道狙击”地图：4800宽的轨道设施，双侧悬浮高地、四条连续坡道、中央三级悬浮平台，支持团队交火和据点争夺。A/D沿坡道移动，S可穿过坡面回到下层，中央新增1440宽的高地观测舱与四处掩体，据点在舱内；进入地图中央下层唯一的传送门按S上舱，舱内橙色门按S返回下层，两端平台可向下射击。高地之间保留远距离狙击射界，下层舱道和货箱提供掩护。独立太空站素材由本地ComfyUI生成。屏幕右侧“拉远/拉近/视野”按钮可手动调节1至3.5倍屏幕范围，点击中间按钮恢复默认；所有职业均可使用，与静止姿态无关。
成长池强化：48张普通卡与8张进化卡同步增强。翻滚补满弹匣、突进伤害爆发、420预算战术盾、移动开火狙击与治疗链开火均可通过局内成长解锁；与职业Perk联动。
...
联机房主可在开局前勾选“添加机器人，补齐4v4”，经典与成长对战均支持；好友加入自动减少机器人，所有真人准备后开始。取消勾选恢复真人对战（成长单人试玩仍有一名训练机器人）。
联机需要网络与可用的配套服务器；本包不附带服务器账号或管理信息。
端口占用时自动尝试其他端口。换端口后浏览器会使用另一份单机存档。
操作：A/D移动，W/空格跳跃，S蹲伏，鼠标射击，Q切枪，R换弹，E主动技能，G道具，U展开/收起局内升级。
成长战斗反馈：本人命中显示实际生命伤害、护甲吸收与短暂敌方血条；击杀、升级、觉醒和选卡生效有独立提示。升级不会自动弹卡，按U选择，比赛继续进行。
本轮平衡：突击兵基础移速提高10%；重型栓狙持枪移速降低15%，射击间隔改为1.8秒。切到副武器解除重狙减速。
